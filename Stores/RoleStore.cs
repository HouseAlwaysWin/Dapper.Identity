...
namespace Dapper.Identity.Stores
{
        ...
        where TRole : IdentityRole<string>
    {
        ...
        public RoleStore(IRolesTable<TRole, string, IdentityRoleClaim<string>> rolesTable, IRoleClaimsTable<string, IdentityRoleClaim<string>> roleClaimsTable, IdentityErrorDescriber describer = null) : base(rolesTable, roleClaimsTable, describer) { }
    }
        ...
        where TRole : IdentityRole<TKey>
    {
        ...
        /// <param name="roleClaimsTable">Abstraction for interacting with RoleClaims table.</param>
        /// <param name="describer">The <see cref="IdentityErrorDescriber"/>.</param>
        public RoleStore(IRolesTable<TRole, TKey, IdentityRoleClaim<TKey>> rolesTable, IRoleClaimsTable<TKey, IdentityRoleClaim<TKey>> roleClaimsTable, IdentityErrorDescriber describer = null) : base(rolesTable, roleClaimsTable, describer) { }
    }
    ...
    where TRoleClaim : IdentityRoleClaim<TKey>, new()
    {
        ...
        public RoleStore(IRolesTable<TRole, TKey, TRoleClaim> rolesTable, IRoleClaimsTable<TKey, TRoleClaim> roleClaimsTable, IdentityErrorDescriber describer) : base(describer)
        {
            ...
            RoleClaimsTable = roleClaimsTable ??
                throw new ArgumentNullException(nameof(roleClaimsTable));
        ...
        public override async Task AddClaimAsync(TRole role, Claim claim, CancellationToken cancellationToken)
        {
            ...
            RoleClaims = RoleClaims ?? (await RoleClaimsTable.GetClaimsAsync(role.Id)).ToList();
